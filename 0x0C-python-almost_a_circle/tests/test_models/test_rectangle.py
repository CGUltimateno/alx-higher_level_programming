...
class TestRectangle(unittest.TestCase):
    ...
    def test_more_than_five_args(self):
        """
        Test creating a Rectangle instance with more five arguments raises TypeError.
        """
        with self.assertRaises(TypeError):
    ...
    def test_kwargs(self):
        """
        Test creating a Rectangle instance with arbitrary number of arguments.
        """
    ...
    def test_args_and_kwargs(self):
        """Test creating a Rectangle instance with both args and kwargs."""
    ...
    def test_empty_args_and_kwargs(self):
        """test creates a Rectangle instance with no arguments"""
        with self.assertRaises(TypeError):
            Rectangle(*(), **{})
